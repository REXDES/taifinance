...
export const PERMISSION_GROUPS: PermissionGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'reports.whatsapp_logs', label: 'Envios por WhatsApp' },
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'payments.transfer', label: 'Transferir saldo' },
      { key: 'payments.fees', label: 'Minhas Taxas' },
      { key: 'payments.pos', label: 'Maquininhas' },
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'admin.modules', label: 'Configuração de Módulos' },
    ],
  },
];
...
export const FINANCE_VIEW_PERMISSION_KEY: Record<string, string> = {
  ...
  'whatsapp-logs': 'reports.whatsapp_logs',
  ...
  'payments-transfer': 'payments.transfer',
  ...
  'payments-admin-settlements': 'payments.admin_settlements',
  'payments-admin-settings': 'payments.admin_settings',
